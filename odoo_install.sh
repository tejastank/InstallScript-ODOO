...
WEBSITE_NAME="yourdomain.com"
# Set the default Odoo longpolling port (you still have to use -c /etc/odoo-server.conf for example to use this.)
LONGPOLLING_PORT="1872"

# Provide Email to register ssl certificate
ADMIN_EMAIL="hello@xamta.in"
...
[Unit]
Description=Odoo Open Source ERP and CRM by XAMTA INFOTECH
...
echo "Odoo installation is complete. Access it at http://your-IP-address:1869"
echo "========================================================================"
